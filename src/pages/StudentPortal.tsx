        ...
        <div style={{
          ...
          <div style={{ padding: "18px 18px 14px", borderBottom: "1px solid var(--border)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              ...
              }}>{user.name.split(" ").map((w: string) => w[0]).join("").slice(0, 2)}</div>
              <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
              {[
                ...
                { label: "Resolved", val: stats.resolved, color: "#166534"        },
              ].map(s => (
                <div key={s.label} style={{ padding: "9px 10px", borderRadius: 8, background: "var(--cream)", border: "1px solid var(--border)", textAlign: "center" }}>
          ...
          {/* Filter tabs */}
          <div style={{ padding: "10px 14px", display: "flex", gap: 6, flexWrap: "wrap", borderBottom: "1px solid var(--border)" }}>
        ...
        <div style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column" }}>
          {view === "new" ? (
            <div style={{ flex: 1, overflowY: "auto", padding: "28px 32px" }}>
              <NewComplaintForm user={user} onSubmit={handleNew}
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "var(--text-3)", gap: 12 }}>
              ...
              <button className="btn btn-gold" style={{ marginTop: 8 }} onClick={() => setView("new")}>
                + New Complaint
              </button>
            </div>
          )}
